...
import { BadgeSchedulerService } from './badge-scheduler.service';
...
@Module({
  ...
  providers: [JobsService, TimesheetsService, AiService, EscrowSchedulerService, BadgeSchedulerService, AiScopingService],
})
