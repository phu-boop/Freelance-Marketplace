...
export class ProfileService {
    ...
    async upsertDraft(userId: string, dto: CreateProfileDraftDto): Promise<Profile> {
        const { education, experience, portfolio, firstName, lastName, phone, country, avatarUrl, ...profileData } = dto;
    ...
    async completeProfile(userId: string): Promise<Profile> {
        ...
        const completionPercentage = this.usersService.calculateCompletionPercentage(updatedUser);
