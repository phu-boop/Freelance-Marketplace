...
docker exec -i freelance_keycloak /opt/keycloak/bin/kcadm.sh update realms/freelance-marketplace -s loginTheme=freelance -s resetPasswordAllowed=true -s "smtpServer={\"from\":\"admin@freelancehub.com\",\"host\":\"mailhog\",\"port\":\"1025\"}"
